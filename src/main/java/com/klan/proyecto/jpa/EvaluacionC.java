...
/**
 * Controlador JPA para insertar, editar, borrar y realizar consultas
 * de la tabla Evaluación.
 * @author patlani
 */
public class EvaluacionC implements Serializable {
    ...
    /**
     *  Entidad que se encarga de conectar la base de datos para
     ...
     * @return EntityManager Devuelve la entidad que conecta la BD.
     */
     ...
     * Verificando que la llave este bien definida y sus listas de relaciones queden actualizadas.
    ...
    /**
     * Método que obtiene la lista de entidades en la tabla Evaluación de la BD.
     * @param maxResults Indice hasta el que se obtienen entidades.
     * @param firstResult Indice desde el que se obtienen entidades.
     * @return Devuelve una lista con las evaluaciónes insertadas en la BD.
     */
